...
export class CompanyTemplateManager {
  ...
  /** Load template by name. Returns null if absent. */
  ...
  /** Return names of saved templates. */
  list(): string[] {
    this.ensureDir();
    return fs
  ...
  /**
   * Export template to the given absolute path.
  ...
  /**
   * Import template from the given absolute path. Returns null on parse failure.

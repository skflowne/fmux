 ...
 *
 * Accuracy: ±50% (for relative comparison)
 */

// Claude Opus 4.6 output: $75 / 1_000_000 tokens
const COST_PER_OUTPUT_TOKEN = 75 / 1_000_000;

// 1 char ≈ 1 token (simple estimate; includes ANSI sequences so slightly high vs reality)
...
export class CostEstimator {
  ...
  // ─── Cost accumulation from PTY output character count ─────────────────────
  ...
  // ─── Cost accumulation from active time (minutes) ────────────────────────
